...
```{r}
data <- read_csv("code/AnlysisOfFactors/Tests/data_bystate_temp_perc.csv")
indexes<-read_csv('code/AnalysisOfFactors/Tests/cluster_index.csv')
