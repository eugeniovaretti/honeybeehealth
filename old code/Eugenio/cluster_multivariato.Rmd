...
## !! righe che servono a creare cluster_idx -> prima runna smoothing amb
cluster_index <- cbind(cluster_index, multi_all_avg = cluster.ea)
cluster_index <- cbind(cluster_index, multi_all_ward = cluster.ew)
library(usmap)
...
cluster_index <- cbind(cluster_index, multi_nopdsi_ward = cluster.ew)
cluster_index <- cbind(cluster_index, multi_nopdsi_avg = cluster.ea)
library(usmap)
...
```{r}
#write.csv(as.data.frame(cluster_index),"../../data/cluster_index.csv", row.names = F)
